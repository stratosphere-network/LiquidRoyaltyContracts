 ...
 * 
 * Usage:
 *   forge script script/UpgradeReserve.s.sol:UpgradeReserve --rpc-url $RPC_URL --broadcast --verify
 * 
 * Dry run (simulate without broadcasting):
 *   forge script script/UpgradeReserve.s.sol:UpgradeReserve --rpc-url $RPC_URL
 */
contract UpgradeReserve is Script {
    ...
    function run() external {
        ...
        console2.log("=================================================");
        console2.log("RESERVE VAULT UPGRADE");
        console2.log("=================================================");
        ...
        console2.log("Step 1: Deploying new Reserve implementation...");
        ConcreteReserveVault newImplementation = new ConcreteReserveVault();
        ...
        console2.log("Current Deposit Cap:", proxy.currentDepositCap());
        console2.log("Backstop Capacity:", proxy.backstopCapacity());
        console2.log("Is Depleted:", proxy.isDepleted());
        console2.log("Utilization Rate:", proxy.utilizationRate());
        console2.log("");
        ...
        console2.log("3. Test Reserve-specific functions (receiveSpillover, provideBackstop)");
        console2.log("4. Monitor deposit cap and backstop capacity");
        console2.log("5. Monitor for any issues");
        console2.log("=================================================");
    }
}
