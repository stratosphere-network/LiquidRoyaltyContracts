...
contract SpilloverLibHarness {
    ...
    function determineZone(uint256 backingRatio) external pure returns (uint8) {
        SpilloverLib.Zone zone = SpilloverLib.determineZone(backingRatio);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}
    ...
    function calculateProfitSpillover(
        ...
        SpilloverLib.ProfitSpillover memory spillover = 
            SpilloverLib.calculateProfitSpillover(netVaultValue, newSupply);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
